...
public class WeatherForecastCommandHandler extends CommandHandler{
    ...
    BotApiMethod<?> commandHandler(Message incomingMessage, String updateId) {
        ...
        if (attributes.size()==0) {
            ...
            log.info("Update ID " + updateId + ": forecast weather request can't be completed due empty information"
                     + "  about city name. Prepared regular notification for user");
        ...
        try {
            log.info("Update ID " + updateId + ": prepared forecast weather request for City " + attributes.get(0));
            ...
            log.info("Update ID " + updateId + ": forecast weather request successfully completed and submitted"
            ...
            log.info("Update ID " + updateId + ": forecast weather request completed but there is no such city ("
